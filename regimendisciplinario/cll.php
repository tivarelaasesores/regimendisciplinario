...
<meta name="theme-color" content="#ffffff">
   ...
   <header>
    ...
    <div class="nav-wrapper">
      <a href="bienvenido.php" class="brand-logo center"><img src="img/logopreguntas.png" width="430px;" id="logo"></a>
  ...
  <ul class="sidenav" id="mobile-demo" style="background-color:#1D5072;">
      ...
      <li><a href="planilla.php"><p style="color:#FFF;">Planilla</p></a></li>
