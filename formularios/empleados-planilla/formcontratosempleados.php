        ...
        <?php
            ...
            if(!empty($array)){
                ...
                for($i=0;$i<sizeof($array);$i++){
                    echo "<tr><td>".$array[$i]["Id_Contrato"]."</td><td>".$array[$i]["Empresa"]."</td><td>".$array[$i]["Empleado"]."</td><td>".$array[$i]["Fecha Subida"]."</td><td><a href='../../archives/uploads/".$Cfile->SinEspecialChars($array[$i]["Empresa"])."/Empleados/".$array[$i]["Empleado"]."/RegimenContratos/".$array[$i]["Ruta"]."'>".$array[$i]["Ruta"]."</a></td><td><a href='formcontratosempleados.php?update=".$array[$i]["Id_Contrato"]."'>Actualizar</a></td></tr>";
                }
                echo"</table>";
            }else{
